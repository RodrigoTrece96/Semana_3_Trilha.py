...
class Pessoa2():
    def __init__(self, nome, status_civil, dinheiro, drink, prato_escolhido): # Usar as descricoes para a conversa entre as pessoas
        self.nome = nome
        self.hobbies_possibilidades = ('correr', 'dançar', 'viajar', 'cantar')
        self.saidas_casuais = ('orla da praia', 'aula de dança', 'aeroporto', 'show')
        self.status_civil = status_civil
...
pessoa1 = Pessoa1('Rodrigo', 'Solteiro', 13, 'Negroni', 'Sushi') 
